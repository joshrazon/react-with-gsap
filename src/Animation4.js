...
const Animation4 = () => {
  ...
  return (
    <div>
      ...
      <div className="box" ref={el => box1 = el}><h1>&uarr; Duration: {animation.duration}s | Stagger {animation.stagger}s &uarr;</h1></div>
      <div className="box" ref={el => box2 = el}><h2>&uarr; Duration: {animation.duration}s | Stagger {animation.stagger}s &uarr;</h2></div>
      <div className="box" ref={el => box3 = el}><h3>&uarr; Duration: {animation.duration}s | Stagger {animation.stagger}s &uarr;</h3></div>
