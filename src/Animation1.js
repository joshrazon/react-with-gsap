...
const Animation1 = () => {
  ...
  return (
    <div>
      ...
      <div className="box" ref={el => box1 = el}><h1>&larr; Duration: {animation.duration}s | Stagger {animation.stagger}s</h1></div>
      <div className="box" ref={el => box2 = el}><h2>&larr; Duration: {animation.duration}s | Stagger {animation.stagger}s</h2></div>
      <div className="box" ref={el => box3 = el}><h3>&larr; Duration: {animation.duration}s | Stagger {animation.stagger}s</h3></div>
